...
export async function ensureBrowserUserRecords(
  ...
  if (existingProfileError) {
    return {
      ok: false as const,
      error:
        "La sesión se abrió, pero no pudimos verificar tu perfil todavía. Intentá nuevamente en unos minutos.",
    };
  }
  ...
  if (!existingProfile) {
    ...
    if (profileError) {
      return {
        ok: false as const,
        error:
          "La sesión se abrió, pero no pudimos completar tu perfil todavía. Intentá nuevamente en unos minutos.",
      };
    }
  }
  ...
  if (participationReadError) {
    return {
      ok: false as const,
      error:
        "La sesión se abrió, pero no pudimos verificar tu inscripción inicial. Intentá nuevamente en unos minutos.",
    };
  }
  ...
  if (!existingParticipation) {
    ...
    if (participationInsertError) {
      return {
        ok: false as const,
        error:
          "La sesión se abrió, pero no pudimos completar tu inscripción inicial. Intentá nuevamente en unos minutos.",
      };
    }
  }
