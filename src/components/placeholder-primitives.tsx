...
export function StatCard({ label, value, detail }: StatCardProps) {
  return (
    <article className="rounded-lg border-[1.5px] border-[var(--color-line)] bg-[var(--color-surface)] p-4">
...
export function ActionTile({
  ...
  return (
    <article className="rounded-lg border-[1.5px] border-[var(--color-line)] bg-[var(--color-surface)] p-5">
...
export function MatchPlaceholderCard({
  ...
  return (
    <article className="overflow-hidden rounded-lg border-[1.5px] border-[var(--color-primary)] bg-[var(--color-surface)]">
...
export function HighlightMetric({ value, label, detail }: HighlightMetricProps) {
  return (
    <article className="rounded-lg border-[1.5px] border-white/15 bg-white/10 p-4 text-white backdrop-blur">
